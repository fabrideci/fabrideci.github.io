...
(function(){
  ...
  var IT = {
    ...
    'node.orchestrator.nm':'Orchestratore', 'node.orchestrator.ro':'smista il lavoro · fa da sviluppatore',
    ...
    'foot.status':'Tutti i sistemi sono operativi',
  ...
  (function caseStudy(){
    ...
    var INFO = {
      ...
      it: {
        orchestrator:{ n:'Orchestratore', r:'smista il lavoro · fa da sviluppatore', o:[
